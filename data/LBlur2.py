...
class LPBlurDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.opt.mode == 'train':
            ...
            try:
                #plate_info = re.sub()
                plate_info = plate_info.replace('-', ' ')
                plate_info = re.sub(r'[^0-9 ]', '', plate_info)
